...
INSERT INTO public.blog_categories (name, slug, description, color, icon, order_index) VALUES
  ('Social Media Tips', 'social-media-tips', 'Best practices for social media marketing', '#3B82F6', 'MessageSquare', 1),
  ('Product Updates', 'product-updates', 'Latest features and improvements', '#10B981', 'Sparkles', 2),
  ('Case Studies', 'case-studies', 'Success stories from our customers', '#F59E0B', 'TrendingUp', 3),
  ('Marketing Strategy', 'marketing-strategy', 'Strategic insights for growth', '#8B5CF6', 'Target', 4),
  ('Industry News', 'industry-news', 'Stay updated with social media trends', '#EF4444', 'Globe', 5)
ON CONFLICT (slug) DO NOTHING;

-- Insert sample author (you can update this with your actual admin user)
INSERT INTO public.blog_authors (display_name, bio, avatar_url) VALUES
  ('SocialCal Team', 'The team behind SocialCal, helping you master social media scheduling.', '/blog/authors/socialcal-team.jpg')
