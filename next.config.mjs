        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              // Connect: API calls
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://api.openai.com https://*.upstash.io https://*.threads.net https://*.facebook.com https://graph.facebook.com https://bsky.social https://*.bsky.network https://vitals.vercel-insights.com https://vercel.live https://va.vercel-scripts.com",
