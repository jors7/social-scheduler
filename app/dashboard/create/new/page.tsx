...
const platforms = [
  ...
  },
  {
    ...
    name: 'Instagram',
    icon: (
      <svg viewBox="0 0 24 24" fill="url(#instagram-gradient-selector)" className="w-6 h-6">
        <defs>
          <linearGradient id="instagram-gradient-selector" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <div className="col-span-1 lg:col-span-1 order-1 lg:order-2 space-y-4">
         ...
         <Card variant="elevated" className="hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                ...
                {/* Platform Selection Buttons - 3 Column Grid */}
                <div className="grid grid-cols-3 gap-3">
                  {platforms.filter(p => !(p as any).isSpecial).map((platform) => {
                    ...
                    return (
                      <button
                        ...
                        title={`${platform.name} - ${hasAccounts ? 'Connected' : 'Not connected'}`}
                        className={cn(
                          "w-full flex items-center justify-center p-4 rounded-lg border-2 transition-all relative min-h-[60px]",
