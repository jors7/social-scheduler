...
export function SignInModal({ open, onOpenChange, onSwitchToSignUp, onSwitchToForgotPassword }: SignInModalProps) {
  ...
  const handleTwitterSignIn = async () => {
    // Twitter OAuth implementation can be added here
    setError('Twitter sign-in coming soon')
  }

  const handleMicrosoftSignIn = async () => {
    // Microsoft OAuth implementation can be added here
          ...
          <div className="p-4 sm:p-6 pt-6 sm:pt-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-1 sm:space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="text-xs sm:text-sm font-medium text-purple-600 hover:text-purple-700 transition-colors"
                    onClick={() => {
            ...
            <div className="space-y-2 sm:space-y-2.5">
              ...
              <button
                ...
                disabled={loading}
              >
                <svg className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 21 21">
