  ...
  return (
    <Card>
      <CardHeader className="pb-3 overflow-visible">
        ...
        {/* Platform tabs */}
        <div className="flex gap-2 overflow-x-auto overflow-y-hidden scrollbar-hide border-b border-gray-200">
          {selectedPlatforms.map((platformId) => {
            ...
            return (
              <button
                ...
                title={platform.name}
                className={cn(
                  'flex items-center justify-center p-2 pb-3 transition-all border-b-2 -mb-[1px]',
