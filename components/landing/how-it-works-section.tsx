...
const HowItWorksSection = () => {
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(to bottom, transparent 0%, white 100%), linear-gradient(to right, rgb(250, 245, 255) 0%, rgb(250, 245, 255) 30%, rgb(243, 232, 255) 70%, rgb(243, 232, 255) 100%)'
      }}
    >
