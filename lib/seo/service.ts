...
const defaultSEO: Partial<SEOSettings> = {
  ...
  og_image: 'https://pub-741f812143544724bbdccee81d8672f5.r2.dev/static-assets/og-header.png',
  og_type: 'website',
  ...
  twitter_image: 'https://pub-741f812143544724bbdccee81d8672f5.r2.dev/static-assets/og-header.png',
  robots: 'index, follow',
  author: 'SocialCal',
}
